...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    electron1.position.set(0.08, 0.06, -0.15);
    scene.add(electron1);

    const electron2 = createElectron(0.15, 0.03, 0.04, 0xFFFF00);
    electron2.position.set(0.15, 0, 0);
    scene.add(electron2);

    const electron3 = createElectron(0.2, 0.02, 0.06, 0x00FF00);
    electron3.position.set(0.2, 0, 0);
    scene.add(electron3);

    addOrbit(scene, 0.1, 0x000000, 0, 0, 0);
    addOrbit(scene, 0.15, 0x000000, 0, Math.PI / 2);
    addOrbit(scene, 0.2, 0x000000, Math.PI / 2, 0, 0);
